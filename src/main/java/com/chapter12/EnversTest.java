...
public class EnversTest {
    ...
    @Test(dependsOnMethods = {"updateUser", "createUser"})
    ...
    @Test(dependsOnMethods = {"updateUser", "createUser", "validateRevisionData"})
    ...
    @Test(dependsOnMethods = {"updateUser", "createUser", "validateRevisionData", "findLastActiveUserRevision"})
